...
from .seed_master import seed_user_master_data
...
def create_app():
    ...
    if not database_url:
        # ไม่มี DATABASE_URL แปลว่าจะใช้ SQLite ใน instance/ ต้องสร้างโฟลเดอร์นี้ก่อน
        # แต่ข้ามขั้นตอนนี้เมื่อมี DATABASE_URL (เช่นบน Vercel ที่ filesystem
        # read-only) เพราะไม่จำเป็นต้องเขียนไฟล์ลงเครื่องเลย
